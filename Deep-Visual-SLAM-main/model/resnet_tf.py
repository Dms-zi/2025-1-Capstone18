...
class Resnet:
    ...
    def build_model(self) -> tf_keras.Model:
        ...
        if self.pretrained:
            pretrained_weights = './Deep-Visual-SLAM-main/assets/weights/resnet18.weights.h5'
            base_model.load_weights(pretrained_weights,skip_mismatch=True)#(pretrained_weights, by_name=True, skip_mismatch=True)
