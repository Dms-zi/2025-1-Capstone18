...
parser.add_argument('--pretrained_dir', type=str, default='./weights/vo/mode=axisAngle_res=384_640_ep=30_bs=16_initLR=1e-05_endLR=1e-05_prefix=Monodepth2-resnet18-Posenet-mars-depthScale/pose_net_epoch_28_model.weights.h5')
...
if __name__ == '__main__':
    ...
    base_model = PoseNet(image_shape=image_shape, batch_size=1)#PoseNetExtra(image_shape=image_shape, batch_size=1)
