...
class MonoVO:
	def __init__(self, intrinsic):
		...
		self.mp = Map()
		self.nn = Networks(depth_weight_path='./Deep-Visual-SLAM-main/weights/vo/mode=axisAngle_res=384_640_ep=30_bs=16_initLR=1e-05_endLR=1e-05_prefix=Monodepth2-resnet18-Posenet-mars-depthScale/depth_net_epoch_28_model.weights.h5',
							pose_weight_path='./Deep-Visual-SLAM-main/weights/vo/mode=axisAngle_res=384_640_ep=30_bs=16_initLR=1e-05_endLR=1e-05_prefix=Monodepth2-resnet18-Posenet-mars-depthScale/pose_net_epoch_28_model.weights.h5',
							image_shape=(384, 640))
