...
try:
    from model.flownet import CustomFlow
...
class PoseNet(tf_keras.Model):
    ...
    def __init__(self,
        ...
        self.encoder = Resnet(image_shape=(self.image_height, self.image_width, 6), batch_size=batch_size, pretrained=False, prefix='resnet18_pose').build_model()
        # 학습할거면 pretrained=True해서 resnet 불러오기 2025-06-09, export_model때문에 false로 수정
        self.encoder.build((self.batch_size, self.image_height, self.image_width, 6))
        self.encoder.trainable = True
