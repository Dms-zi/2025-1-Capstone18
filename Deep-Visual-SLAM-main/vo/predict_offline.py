...
if __name__ == '__main__':
    ...
    with tf.device('/GPU:0'):
        ...
        #exp_name = 'mode=axisAngle_res=480_640_ep=30_bs=16_initLR=1e-05_endLR=1e-05_prefix=Monodepth2-resnet18-Posenet-mars-depthScale'
        depth_net.load_weights(r'./Deep-Visual-SLAM-main/weights/vo/mode=axisAngle_res=384_640_ep=30_bs=16_initLR=1e-05_endLR=1e-05_prefix=Monodepth2-resnet18-Posenet-mars-depthScale/depth_net_epoch_28_model.weights.h5')
        ...
        pose_net.load_weights(r'./Deep-Visual-SLAM-main/weights/vo/mode=axisAngle_res=384_640_ep=30_bs=16_initLR=1e-05_endLR=1e-05_prefix=Monodepth2-resnet18-Posenet-mars-depthScale/pose_net_epoch_28_model.weights.h5')
        ...
        visualizer = Visualizer(window_size=(1920, 1080),
                                draw_plane=True, is_record=True, video_fps=30, video_name="after_BA.mp4")

        poses = np.load('./test.npy')
        print("ok poses:", poses.shape)
