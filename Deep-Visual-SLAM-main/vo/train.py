...
class Trainer(object):
    ...
    def train(self) -> None:        
        for epoch in range(self.config['Train']['epoch']):    
            ...
            # Reset metrics        
            self.train_total_loss.reset_state()
            self.train_pixel_loss.reset_state()
            self.train_smooth_loss.reset_state()
            self.valid_total_loss.reset_state()
            self.valid_pixel_loss.reset_state()
            self.valid_smooth_loss.reset_state()
